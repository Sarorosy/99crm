            ...
            <div className="my-3 flex mx-auto rep">
                ...
                <div className='ml-3 flex items-center justify-end'>
                    ...
                    <button
                        ...
                        className="bg-green-600 w-36 px-2 h-8 ml-3 text-white rounded hover:bg-green-700"
                    >
                        Apply
                    </button>
                    ...
                    {sessionStorage.getItem('user_type') === 'user' && (
                        <button
                            ...
                            className="bg-orange-600 w-48 h-8 px-2 ml-3 text-white rounded hover:bg-orange-700"
                        >
                            Add New Payment
                        </button>
                    )}
