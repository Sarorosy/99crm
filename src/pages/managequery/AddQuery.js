...
const AddQuery = () => {
    ...
    const handleLocationChange = async (e) => {
        ...
        const countryId = countries.find((country) => country.id == location)?.id;
        if (countryId) {
            try {
    ...
    const apiUrl = "https://99crm.phdconsulting.in/99crmwebapi/api/createquery";
                    ...
                    <div className="row form-group">
                        ...
                        <div className="col-sm-3">
                            <div className="form-group" style={{ marginTop: "22px" }}>
                                ...
                                />
                                <label htmlFor="withoutemail"> Check If Camp Query</label>
                            </div>
                        </div>
                        <div className="col-sm-3">
