...
const QueryInfoTab = ({ QueryInfo, expandStatus }) => {
    return (
        QueryInfo && (
            <div className="space-y-2 text-sm text-gray-700 bg-blue-50 p-2 rounded-lg thirteenpx">
                {expandStatus ? (
                    // Expanded View - 3 Columns
                    <div className="space-y-2">
                        <div className="flex items-center">
                            <label className="w-1/3 font-semibold text-gray-900">Ref No.</label>
                            <div className="w-2/3 px-2 py-0.5 bg-blue-100 roun">{QueryInfo.assign_id}</div>
                        </div>
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center">
                            <label className="w-1/3 w-1/3 font-semibold text-gray-900">Ref No.</label>
                            <div className="w-2/3 px-2 py-0.5 bg-blue-100 rounded">{QueryInfo.assign_id}</div>
                        </div>

                        <div className="flex items-center">
                            <label className="w-1/3 w-1/3 font-semibold text-gray-900">Client Name</label>
                            <div className="w-2/3 px-2 py-0.5 bg-blue-100 rounded">{QueryInfo.name}</div>
                        </div>

                        <div className="flex items-center">
                            <label className="w-1/3 w-1/3 font-semibold text-gray-900">Email Id</label>
