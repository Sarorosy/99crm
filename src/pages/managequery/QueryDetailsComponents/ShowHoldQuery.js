...
const ShowHoldQuery = ({ queryInfo, finalFunction }) => {
    ...
    return (
        <div className="bg-white shadow-md rounded-xl p-6 space-y-6" id="activityHistoryArea">
            <div className="border-b pb-4">
                <h2 className="text-xl font-semibold text-gray-800">Assign Hold Query</h2>
            </div>

            <div className="space-y-2">
                <div>
                    <h4 className="text-lg font-medium text-gray-700 mb-2">Query Details</h4>
                ...
                <div className="flex justify-end space-x-4 pt-4">
                    <button
                        type="button"
                        className={`px-3 py-1 rounded-md text-[#006c81] ${loading ? "bg-gray-400 cursor-not-allowed" : "bg-[#cfe1e5]  border border-[#006c81]"
                            }`}
