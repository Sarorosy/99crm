...
const LeadIn = ({ queries , loading}) => {
    ...
    return (
        <div className="open-tasks-container" style={{ padding: '20px 8px', border: '1px solid #ddd', borderRadius: '6px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)', backgroundColor: '#f0a04b', maxWidth: '350px' }}>
            <h1 style={{ fontSize: '16px', fontWeight: 'bold', color: '#02313a', marginBottom: '15px' }}>Lead In <span className='text-green-400 bg-transparent rouneded-full px-1 py-1'>({queries && queries.length})</span></h1>
